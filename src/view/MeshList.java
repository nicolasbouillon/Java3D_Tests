...
public class MeshList {
	 ...
	 */
	private ArrayList<TriangleMeshView> meshList=new ArrayList<TriangleMeshView>(); 
...
//						Color.white), 64);
		...
		try {
			...
			this.meshList.add(new TriangleMeshView(parser.read()));
	 ...
	 */
	public void addMesh(TriangleMeshView triangleMeshView){
		this.meshList.add(triangleMeshView);
	}
	
	public ArrayList<TriangleMeshView> getMeshList(){
